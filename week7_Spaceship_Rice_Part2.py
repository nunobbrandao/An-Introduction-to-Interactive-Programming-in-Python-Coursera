...
def rock_spawner():
    ...
    a_rock.angle_vel=(random.random()+.1)/10
    a_rock.vel[0]=(random.random()+.1)*random.choice([-1,1])
    a_rock.vel[1]=(random.random()+.1)*random.choice([-1,1])
    
# Definition of key handlers
def key_handler_down(key):
    if simplegui.KEY_MAP['left']==key:
        ...
        my_ship.thrust=True
        my_ship.image_center[0]+= my_ship.image_size[0] #change picture to show thrusters 
...
def key_handler_up(key):
    if simplegui.KEY_MAP['left']==key:
        ...
        my_ship.image_center[0]-= my_ship.image_size[0] #change picture to erase thrusters
